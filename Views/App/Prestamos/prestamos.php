        ...
        <div class="row">
            <div class="col-12 col-md-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="txtCod" placeholder="0123" aria-describedby="button-addon2">
                    <button class="btn btn-outline-secondary" type="button" id="button-addon2" onclick="bsc_lector();"><i class='bx bx-search-alt-2'></i></button>
                </div>
            </div>
    ...
    <div class="body px-md-5 pb-md-5">
        <div class="row">
            ...
            <div class="col-12 text-center">
                <button class="btn btn-primary">Generar Servicio</button>
            </div>
        </div>
    </div>
</div>

<div id="step2" class="card mt-4">
