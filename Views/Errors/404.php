...
<body>
    ...
    <div id="author">
        <h1><?= NOMBRE_EMPRESA; ?></h1><span><a href="javascript:history.back()">volver</a></span>
    </div>

    <script src="<?php echo media() . 'js/plugins/jquery.min.js'; ?>"></script>
    <script src="<?php echo media() . 'js/plugins/howler.min.js'; ?>"></script>
    <script>
